<?php $__env->startSection('title', 'صندوق پیام‌ها'); ?>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="<?php echo e(route('inbox.markAllAsRead')); ?>" class="btn btn-sm btn-primary">
                    ...
                    <ul class="nav nav-tabs notification-tabs mb-4">
                        <li class="nav-item">
                            <a class="nav-link active" id="standard-tab" data-bs-toggle="tab" href="#standard-notifications">
                                اعلان‌های استاندارد
                                <?php if($dbNotifications->count() > 0): ?>
                                    <span class="badge bg-primary ms-1"><?php echo e($dbNotifications->count()); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="wallet-tab" data-bs-toggle="tab" href="#wallet-notifications">
                                اعلان‌های کیف پول
                                <?php if($walletNotifications->count() > 0): ?>
                                    <span class="badge bg-primary ms-1"><?php echo e($walletNotifications->count()); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="standard-notifications">
                            <?php if($dbNotifications->count() > 0): ?>
                                <div class="notifications-list">
                                    <?php $__currentLoopData = $dbNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <div class="notification-item p-3 <?php echo e($isRead ? '' : 'unread'); ?>" data-id="<?php echo e($notification->id); ?>" data-type="standard">
                                            <div class="d-flex align-items-start">
                                                <div class="notification-icon bg-label-<?php echo e($color); ?> me-3">
                                                    <i class="bx <?php echo e($icon); ?>"></i>
                                                </div>
                                                
                                                <div class="flex-grow-1">
                                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                                        <h6 class="notification-title"><?php echo e($notificationData['title'] ?? 'اعلان جدید'); ?></h6>
                                                        <small class="notification-time"><?php echo e($notification->created_at->diffForHumans()); ?></small>
                                                    </div>
                                                    
                                                    <p class="notification-content mb-1"><?php echo e($notificationData['message'] ?? ''); ?></p>
                                                    
                                                    <?php if(isset($notificationData['description']) && !empty($notificationData['description'])): ?>
                                                        <small class="text-muted"><?php echo e($notificationData['description']); ?></small>
                                                    <?php endif; ?>
                                                    
                                                    <div class="mt-2">
                                                        <a href="<?php echo e(route('inbox.readAndRedirect', ['id' => $notification->id, 'type' => 'standard'])); ?>" class="btn btn-sm btn-outline-<?php echo e($color); ?>">
                                                            <i class="bx bx-link-external me-1"></i>مشاهده جزئیات
                                                        </a>
                                                        
                                                        <?php if(!$isRead): ?>
                                                            <button type="button" class="btn btn-sm btn-outline-secondary mark-read ms-2" data-id="<?php echo e($notification->id); ?>" data-type="standard">
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <?php echo e($dbNotifications->links()); ?>
                            ...
                            <?php if($walletNotifications->count() > 0): ?>
                                <div class="notifications-list">
                                    <?php $__currentLoopData = $walletNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="notification-item p-3 <?php echo e($isRead ? '' : 'unread'); ?>" data-id="<?php echo e($notification->id); ?>" data-type="wallet">
                                            <div class="d-flex align-items-start">
                                                <div class="notification-icon bg-label-<?php echo e($color); ?> me-3">
                                                    <i class="bx <?php echo e($icon); ?>"></i>
                                                </div>
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                                        <h6 class="notification-title"><?php echo e($notificationData['title'] ?? 'اعلان کیف پول'); ?></h6>
                                                        <small class="notification-time"><?php echo e($notification->created_at->diffForHumans()); ?></small>
                                                    </div>
                                                    ...
                                                    <div class="mt-2">
                                                        <a href="<?php echo e(route('inbox.readAndRedirect', ['id' => $notification->id, 'type' => 'wallet'])); ?>" class="btn btn-sm btn-outline-<?php echo e($color); ?>">
                                                            <i class="bx bx-link-external me-1"></i>مشاهده جزئیات
                                                        </a>
                                                        
                                                        <?php if(!$isRead): ?>
                                                            <button type="button" class="btn btn-sm btn-outline-secondary mark-read ms-2" data-id="<?php echo e($notification->id); ?>" data-type="wallet">
                                                                <i class="bx bx-check me-1"></i>خوانده شد
                                                            </button>
                                                        <?php endif; ?>
                                                    </div>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <?php echo e($walletNotifications->links()); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.mark-read').forEach(button => {
            button.addEventListener('click', function() {
                ...
                fetch('<?php echo e(route("inbox.markAsRead")); ?>', {
                    method: 'POST',
                    headers: {
        ...
        const markAllAsReadLink = document.querySelector('a[href="<?php echo e(route("inbox.markAllAsRead")); ?>"]');
        if (markAllAsReadLink) {
            markAllAsReadLink.addEventListener('click', function(e) {
                e.preventDefault();
                
                // Send AJAX request to mark all as read
                fetch('<?php echo e(route("inbox.markAllAsRead")); ?>', {
                    method: 'GET',
                    headers: {
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/club/resources/views/inbox/index.blade.php ENDPATH**/ ?>