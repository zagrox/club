<?php $__env->startSection('title', 'تنظیمات پرداخت'); ?>
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <?php if(session('paymentUrl')): ?>
        <div class="alert alert-info alert-dismissible" role="alert">
            <p>برای تست درگاه پرداخت، روی لینک زیر کلیک کنید:</p>
            <a href="<?php echo e(session('paymentUrl')); ?>" target="_blank" class="btn btn-sm btn-primary">
                                ...
                                <div class="card-body">
                                    <form id="zibalSettingsForm">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="field-container">
                                                    ...
                                                    <input type="text" class="form-control" id="merchant" name="merchant" value="<?php echo e($zibalConfig['merchant']); ?>">
                                            ...
                                            <div class="col-md-4">
                                                <div class="field-container">
                                                    ...
                                                    <select class="form-select" id="log_channel" name="log_channel">
                                                        <option value="daily" <?php echo e($zibalConfig['log_channel'] == 'daily' ? 'selected' : ''); ?>>روزانه</option>
                                                        <option value="single" <?php echo e($zibalConfig['log_channel'] == 'single' ? 'selected' : ''); ?>>تک فایل</option>
                                                        <option value="stack" <?php echo e($zibalConfig['log_channel'] == 'stack' ? 'selected' : ''); ?>>مجموعه</option>
                                                    </select>
                                        ...
                                        <div class="field-container">
                                            ...
                                            <input type="text" class="form-control" id="callback_url" name="callback_url" value="<?php echo e($zibalConfig['callback_url']); ?>">
                                        ...
                                        <div class="field-container">
                                            ...
                                            <input type="text" class="form-control" id="description_prefix" name="description_prefix" value="<?php echo e($zibalConfig['description_prefix']); ?>">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-4">
                                                <div class="toggle-wrapper mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="sandbox" name="sandbox" <?php echo e($zibalConfig['sandbox'] ? 'checked' : ''); ?>>
                                            ...
                                            <div class="col-md-4">
                                                <div class="toggle-wrapper mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="mock" name="mock" <?php echo e($zibalConfig['mock'] ? 'checked' : ''); ?>>
                                            ...
                                            <div class="col-md-4">
                                                <div class="toggle-wrapper mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="log_enabled" name="log_enabled" <?php echo e($zibalConfig['log_enabled'] ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-4">
                            <div class="card settings-card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="testZibalForm" action="<?php echo e(route('payment-options.zibal.test')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="card settings-card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="d-grid gap-2">
                                        ...
                                        <a href="<?php echo e(url('docs/zibal-integration.md')); ?>" target="_blank" class="btn btn-outline-info">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function submitZibalSettings() {
        ...
        // Send AJAX request
        fetch('<?php echo e(route('payment-options.zibal.update')); ?>', {
            method: 'POST',
            body: formData,
            headers: {
    ...
    if (formResetButton) {
        formResetButton.addEventListener('click', function() {
            ...
            document.getElementById('sandbox').checked = <?php echo e($zibalConfig['sandbox'] ? 'true' : 'false'); ?>;
            document.getElementById('mock').checked = <?php echo e($zibalConfig['mock'] ? 'true' : 'false'); ?>;
            document.getElementById('log_enabled').checked = <?php echo e($zibalConfig['log_enabled'] ? 'true' : 'false'); ?>;
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/club/resources/views/payment-options/index.blade.php ENDPATH**/ ?>