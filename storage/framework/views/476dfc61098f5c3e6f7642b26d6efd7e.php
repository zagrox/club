      ...
      <div class="card-body d-flex flex-column justify-content-between">
        <div class="row">
          ...
          <div class="col-4 text-center">
            <img src="<?php echo e(asset('assets/img/illustrations/trophy.png')); ?>" class="achievement-icon" alt="Achievement">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card tools-card">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-4 text-center">
            <img src="<?php echo e(asset('assets/img/illustrations/man-with-laptop.png')); ?>" class="achievement-icon" alt="Contact Management">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card tools-card">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-4 text-center">
            <img src="<?php echo e(asset('assets/img/illustrations/woman-with-laptop.png')); ?>" class="achievement-icon" alt="Start Design">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card tools-card">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-4 text-center">
            <img src="<?php echo e(asset('assets/img/illustrations/superman.png')); ?>" class="achievement-icon" alt="Reports">
          </div>
        </div>
      </div>
    </div>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/club/resources/views/pages/tools.blade.php ENDPATH**/ ?>