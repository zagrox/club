    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      document.querySelectorAll('.mark-as-read').forEach(button => {
        button.addEventListener('click', function(e) {
          ...
          fetch('<?php echo e(route("notification-center.mark-as-read")); ?>', {
            method: 'POST',
            headers: {
      ...
      document.querySelectorAll('.dismiss-notification').forEach(button => {
        button.addEventListener('click', function(e) {
          e.preventDefault();
          const notificationId = this.dataset.id;
          fetch('<?php echo e(route("notification-center.dismiss")); ?>', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
      ...
      document.querySelectorAll('.archive-notification').forEach(button => {
        button.addEventListener('click', function(e) {
          e.preventDefault();
          const notificationId = this.dataset.id;
          fetch('<?php echo e(route("notification-center.archive")); ?>', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
      ...
      <div class="card">
        <div class="card-body d-flex justify-content-between align-items-center flex-wrap">
          ...
          <div class="d-flex align-items-center">
            ...
            <a href="<?php echo e(route('notification-center.create')); ?>" class="btn btn-success me-2">
              <i class="bx bx-plus me-1"></i>
              Add New
            </a>
            <a href="<?php echo e(route('notification-center.settings')); ?>" class="btn btn-primary">
    ...
    <div class="col-md-8 col-12 mb-4">
      <div class="card h-100">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <a href="<?php echo e(route('notification-center.archived')); ?>" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-12 mb-4">
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <a href="<?php echo e(route('notification-center.settings')); ?>" class="btn btn-text-primary p-0">View All</a>
            </div>
            <div class="card-body">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/club/resources/views/pages/notification-center/index.blade.php ENDPATH**/ ?>