      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            ...
            <p class="mb-4">
              You have successfully integrated the <span class="fw-bold">Sneat</span> admin template with Laravel.
            </p>
    ...
    <div class="card">
      <div class="row row-bordered g-0">
        ...
        <div class="col-md-4">
          ...
          <div id="growthChart" style="min-height: 154px;"></div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
              ...
              <div id="profileReportChart" style="min-height: 158px;"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <div id="orderStatisticsChart" style="min-height: 137px;"></div>
        </div>
        <ul class="p-0 m-0">
      ...
      <div class="card-body px-0">
        <div class="tab-content p-0">
          <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
            <div id="expensesOfWeek" style="min-height: 315px;"></div>
          </div>
        </div>
      </div>
    </div>
