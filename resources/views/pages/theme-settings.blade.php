      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            <div class="card option-card {{ $themeConfig['mode'] === 'light' ? 'active-option' : '' }}" id="light-mode-option">
              <div class="card-body p-3">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="theme-mode" id="light-mode-radio" value="light" {{ $themeConfig['mode'] === 'light' ? 'checked' : '' }}>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- Dark Mode -->
          <div class="col-md-4 mb-3">
            <div class="card option-card {{ $themeConfig['mode'] === 'dark' ? 'active-option' : '' }}" id="dark-mode-option">
              <div class="card-body p-3">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="theme-mode" id="dark-mode-radio" value="dark" {{ $themeConfig['mode'] === 'dark' ? 'checked' : '' }}>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- System Mode -->
          <div class="col-md-4 mb-3">
            <div class="card option-card {{ $themeConfig['mode'] === 'system' ? 'active-option' : '' }}" id="system-mode-option">
              <div class="card-body p-3">
                <div class="theme-option-preview">
                  <div class="theme-preview-header">
                    <div class="preview-dots">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="theme-mode" id="system-mode-radio" value="system" {{ $themeConfig['mode'] === 'system' ? 'checked' : '' }}>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            <div class="card option-card {{ !($themeConfig['is_rtl'] ?? false) ? 'active-option' : '' }}" id="ltr-option">
              <div class="card-body p-3">
                <div class="theme-option-preview">
                  <div class="theme-preview-header">
                    <div class="preview-dots">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="direction" id="ltr-radio" value="ltr" {{ !($themeConfig['is_rtl'] ?? false) ? 'checked' : '' }}>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- RTL Direction -->
          <div class="col-md-6 mb-3">
            <div class="card option-card {{ ($themeConfig['is_rtl'] ?? false) ? 'active-option' : '' }}" id="rtl-option">
              <div class="card-body p-3">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="direction" id="rtl-radio" value="rtl" {{ ($themeConfig['is_rtl'] ?? false) ? 'checked' : '' }}>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          <!-- Expanded Menu -->
          <div class="col-md-6 mb-3">
            <div class="card option-card {{ !($themeConfig['menu_collapsed'] ?? false) ? 'active-option' : '' }}" id="expanded-menu-option">
              <div class="card-body p-3">
                <div class="theme-option-preview">
                  <div class="theme-preview-header">
                    <div class="preview-dots">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="menu-collapsed" id="expanded-menu-radio" value="false" {{ !($themeConfig['menu_collapsed'] ?? false) ? 'checked' : '' }}>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- Collapsed Menu -->
          <div class="col-md-6 mb-3">
            <div class="card option-card {{ ($themeConfig['menu_collapsed'] ?? false) ? 'active-option' : '' }}" id="collapsed-menu-option">
              <div class="card-body p-3">
                <div class="theme-option-preview">
                  <div class="theme-preview-header">
                    <div class="preview-dots">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="menu-collapsed" id="collapsed-menu-radio" value="true" {{ ($themeConfig['menu_collapsed'] ?? false) ? 'checked' : '' }}>
                  </div>
                </div>
              </div>
            </div>
