  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ request()->routeIs('tools') ? 'active' : '' }}">
      <a href="{{ route('tools') }}" class="menu-link">
        ...
        <div data-i18n="Tools">{{ __('messages.tools') }}</div>
      </a>
    </li>
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">{{ __('messages.admin_menu') }}</span>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('users.list') ? 'active' : '' }}">
      <a href="{{ route('users.list') }}" class="menu-link">
        ...
        <div data-i18n="Users List">{{ __('messages.users_list') }}</div>
      </a>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('admin.payments.*') ? 'active open' : '' }}">
      <a href="{{ route('admin.payments.index') }}" class="menu-link">
        ...
        <div data-i18n="Payments">{{ __('messages.transactions') }}</div>
      </a>
    </li>
    @endif
    ...
    <li class="menu-item {{ request()->routeIs('orders.*') ? 'active open' : '' }}">
      <a href="{{ route('orders.list') }}" class="menu-link">
        ...
        <div data-i18n="Orders List">{{ __('messages.orders_list') }}</div>
      </a>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('notification-center.*') ? 'active open' : '' }}">
      <a href="{{ route('notification-center.index') }}" class="menu-link">
        ...
        <div data-i18n="Notification Center">{{ __('messages.message_center') }}</div>
      </a>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('payment-options.*') ? 'active open' : '' }}">
      <a href="{{ route('payment-options.index') }}" class="menu-link">
        ...
        <div data-i18n="Payment Options">{{ __('messages.payment_options') }}</div>
      </a>
    </li>
    @endif
    ...
    @if(Auth::check() && Auth::user()->hasRole('admin'))
    <li class="menu-item {{ request()->routeIs('translations.*') ? 'active open' : '' }}">
      <a href="{{ route('translations.index') }}" class="menu-link">
        <i class="menu-icon tf-icons bx bx-globe"></i>
        <div data-i18n="Language Manager">{{ __('messages.language_manager') }}</div>
      </a>
    </li>
    @endif
    ...
    <li class="menu-item {{ request()->routeIs('change-logs') ? 'active' : '' }}">
      <a href="{{ route('change-logs') }}" class="menu-link">
        ...
        <div data-i18n="Change Logs">{{ __('messages.change_logs') }}</div>
      </a>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('backup.index') ? 'active' : '' }}">
      <a href="{{ route('backup.index') }}" class="menu-link">
        ...
        <div data-i18n="Backup Management">{{ __('messages.backup_manager') }}</div>
      </a>
    </li>
    @endif
    ...
    <!-- Help Center -->
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">{{ __('messages.help_center') }}</span>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('faq') ? 'active' : '' }}">
      <a href="{{ route('faq') }}" class="menu-link">
        ...
        <div data-i18n="FAQ">{{ __('messages.faq') }}</div>
      </a>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('cards.*') ? 'active' : '' }}">
      <a href="{{ route('cards.basic') }}" class="menu-link">
        ...
        <div data-i18n="Basic">{{ __('Pricing Cards') }}</div>
      </a>
    </li>
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item {{ request()->routeIs('ui.collapse') ? 'active' : '' }}">
          <a href="{{ route('ui.collapse') }}" class="menu-link">
            <div data-i18n="Collapse">{{ __('Collapse') }}</div>
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('tables.*') ? 'active' : '' }}">
      <a href="{{ route('tables.basic') }}" class="menu-link">
        ...
        <div data-i18n="Tables">{{ __('Tables') }}</div>
      </a>
    </li>
    
    <!-- Customization -->
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">{{ __('User Options') }}</span>
    </li>
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item {{ request()->routeIs('settings.security') ? 'active' : '' }}">
          <a href="{{ route('settings.security') }}" class="menu-link">
            <div data-i18n="Security">{{ __('Security') }}</div>
          </a>
        </li>
        ...
        <li class="menu-item {{ request()->routeIs('settings.connections') ? 'active' : '' }}">
          <a href="{{ route('settings.connections') }}" class="menu-link">
            <div data-i18n="Connections">{{ __('Connections') }}</div>
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('theme.*') ? 'active' : '' }}">
      <a href="{{ route('theme.settings') }}" class="menu-link">
        ...
        <div data-i18n="Theme Settings">{{ __('Theme Settings') }}</div>
      </a>
    </li>
